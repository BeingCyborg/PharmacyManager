        ...
        <div class="dashboard-container">
            ...
            <div id="main">
                <div class="tabbed_box">
                    <h4><i class="fas fa-user-tie"></i>Manage Managers</h4>
                    <div class="tabbed_area">
                        ...
                        <div id="content_1" class="content" style="display: block;">
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                echo "<tr>";
                                echo '<td><span class="user-id">#' . $row['manager_id'] . '</span></td>';
                                echo '<td>' . $row['first_name'] . '</td>';
                                echo '<td>' . $row['last_name'] . '</td>';
                                echo '<td>' . $row['username'] . '</td>';
                                echo '<td class="action-icons">
                                        <a href="update_manager.php?username=' . $row['username'] . '&fname=' . $row['first_name'] . '" 
                                           title="Update User">
                                            <i class="fas fa-edit update-icon"></i>
                                        </a>
                                        <a href="delete_manager.php?manager_id=' . $row['manager_id'] . '" 
                        ...
                        <div id="content_2" class="content">
                            ...
                            <form name="form1" onsubmit="return validateForm();" action="admin_manager.php" method="post">
                                ...
                                <div class="form-group" style="text-align: center;">
                                    <button type="submit" name="submit" class="submit-btn">Add Manager</button>
                                </div>
                            </form>
                        </div>
                    </div>
