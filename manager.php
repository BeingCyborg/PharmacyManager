...
if(isset($_SESSION['username'])){
    $id = isset($_SESSION['manager_id']) ? $_SESSION['manager_id'] : '';
    $fname = isset($_SESSION['first_name']) ? $_SESSION['first_name'] : 'Manager';
    $lname = isset($_SESSION['last_name']) ? $_SESSION['last_name'] : 'User';
    $sid = isset($_SESSION['staff_id']) ? $_SESSION['staff_id'] : 'MGR001';
            ...
            <div id="left_column">
                <div id="button">
                    <ul>
                        ...
                        <li><a href="stock.php"><i class="fas fa-boxes"></i>Manage Stock</a></li>
