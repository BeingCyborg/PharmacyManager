...
<head>
    ...
    <script>
        ...
        function validateForm() {
            ...
            if (drugName === "") {
                alert("Drug Name Field is Empty");
                return false;
            }
        ...
        <div class="dashboard-container">
            ...
            <div id="main">
                <div class="tabbed_box">
                    <h4><i class="fas fa-boxes"></i>Manage Stock</h4>
                    <div class="tabbed_area">
                        ...
                        <div id="content_2" class="content">
                            ...
                            <form name="myform" onsubmit="return validateForm();" action="stock_pharmacist.php" method="post">
                                ...
                                <div class="form-group">
                                    <input name="cost" type="number" placeholder="Unit Cost" required="required" id="cost" />
                                </div>
                                <div class="form-group">
