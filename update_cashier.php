...
<div id="content">
<div id="header">
<h1><a href="#"><img src="images/main_logo.png"></a> Pharmacy Management System</h1></div>
<div id="left_column">
<div id="button">
<ul>
...
<hr/>	
    <div class="tabbed_area">  
		...
		<?php echo $message1;?>
          <form name="myform" onUpdate="return validateForm(this);" action="admin_cashier.php" method="post" >
...
<div id="footer" align="Center"> Developed By BeingCyborg</div>
</div>
</body>
</html>
